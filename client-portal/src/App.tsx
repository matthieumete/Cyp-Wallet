    ...
    <header className="border-b border-[var(--color-shell)]/70 bg-[var(--color-cream)]/80 backdrop-blur-sm sticky top-0 z-40">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-11 h-11 rounded-2xl bg-[var(--color-olive)] flex items-center justify-center shadow-sm">
        ...
        <nav className="flex items-center gap-2">
          <button className="hidden sm:inline-flex px-4 py-2 text-sm font-medium text-[var(--color-wood-soft)] hover:text-[var(--color-olive-dark)] transition-colors cursor-pointer">
            Connexion
          </button>
          <button className="inline-flex items-center gap-1.5 px-5 py-2.5 bg-[var(--color-olive)] hover:bg-[var(--color-olive-dark)] text-[var(--color-cream)] rounded-full text-sm font-semibold shadow-sm transition-all active:scale-[0.98] cursor-pointer">
            Créer un compte
      ...
      <div className="grid md:grid-cols-5 gap-10 items-center">
        <div className="md:col-span-3 space-y-6">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            <button className="inline-flex items-center gap-2 px-6 py-3.5 bg-[var(--color-terracotta)] hover:bg-[var(--color-terracotta-dark)] text-[var(--color-cream)] rounded-full text-sm font-semibold shadow-md shadow-[var(--color-terracotta)]/20 transition-all active:scale-[0.98] cursor-pointer">
              Créer mon compte gratuit
              <ArrowRight className="w-4 h-4" />
            </button>
            <button className="inline-flex items-center gap-2 px-6 py-3.5 bg-transparent hover:bg-[var(--color-shell)]/60 border border-[var(--color-stone)]/70 text-[var(--color-wood-soft)] rounded-full text-sm font-semibold transition-all cursor-pointer">
